...
const simulCategories: Array<Categories> = [
  ...
  { name: "Preparing", cardNum: 6, subText: "Preparing..." },
  { name: "Preparing", cardNum: 7, subText: "Preparing..." },
  { name: "Preparing", cardNum: 8, subText: "Preparing..." },
  { name: "Preparing", cardNum: 9, subText: "Preparing..." },
  { name: "Preparing", cardNum: 10, subText: "Preparing..." },
  { name: "Preparing", cardNum: 11, subText: "Preparing..." },
  { name: "Preparing", cardNum: 12, subText: "Preparing..." },
  { name: "Preparing", cardNum: 13, subText: "Preparing..." },
  { name: "Preparing", cardNum: 14, subText: "Preparing..." },
  { name: "Preparing", cardNum: 15, subText: "Preparing..." },
  { name: "Preparing", cardNum: 16, subText: "Preparing..." },
